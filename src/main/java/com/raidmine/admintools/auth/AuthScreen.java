...
import net.minecraft.client.gui.widget.PasswordWidget;
...
public class AuthScreen extends Screen {
    ...
    private static final Identifier BG_TEXTURE = Identifier.of("raidmine-admin-tools", "textures/gui/auth_bg.png");
    ...
    protected void init() {
        ...
        this.passwordField = new PasswordWidget(this.textRenderer, centerX - 100, centerY - 25, 200, 20,
